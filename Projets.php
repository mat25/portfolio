    ...
    <div class="details-projet d-flex justify-content-center align-items-center">
        ...
        <?php } else { ?>
            <div class="row">
                ...
                <div
                    class="col col-12 col-xl-5 order-1 order-xl-0 d-flex flex-column flex justify-content-center colonneDivCarrousel">
                    ...
                    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                        <div class="recapImage carousel-indicators">
                            ...
                            foreach ($tabProjet[$id]["images"] as $image) { ?>
                                <img class="PetiteImage w-25 h-25 active" src="images/Projets/<?= $id ?>/<?= $image ?>"
                                    data-bs-target="#carouselExampleIndicators" data-bs-slide-to="<?= $compteur ?>"
                                    aria-current="true" aria-label="Slide <?= $compteur + 1 ?>" alt="">
                                <?php
                                $compteur += 1;
                            } ?>
                        </div>
